...
import kimty.app.domain.Client;
import kimty.app.repository.ClientRepository;
...
public class ClientResourceIT {
    ...
    private static final String DEFAULT_NUM_PIECE = "AAAAAAAAAA";
    private static final String UPDATED_NUM_PIECE = "BBBBBBBBBB";
    ...
    public void createClient() throws Exception {
        ...
        assertThat(testClient.getNumPiece()).isEqualTo(DEFAULT_NUM_PIECE);
    ...
    public void getAllClients() throws Exception {
        ...
        restClientMockMvc.perform(get("/api/clients?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].numPiece").value(hasItem(DEFAULT_NUM_PIECE)))
    ...
    public void getClient() throws Exception {
        ...
        restClientMockMvc.perform(get("/api/clients/{id}", client.getId()))
            ...
            .andExpect(jsonPath("$.numPiece").value(DEFAULT_NUM_PIECE))
    ...
    public void updateClient() throws Exception {
        ...
        Client testClient = clientList.get(clientList.size() - 1);
        assertThat(testClient.getNumPiece()).isEqualTo(UPDATED_NUM_PIECE);
